...
# create config file
cat /etc/nginx/template/default.template | envsubst '$$VHOST_NAME $$WORDPRESS_VHOST_NAME $$SSL_CERT_PATH $$SSL_CERTKEY_PATH $$SSL_STAPLING_VERIFY $$SSL_TRUSTED_CERTIFICATE_PATH' > /etc/nginx/conf.d/default.conf
